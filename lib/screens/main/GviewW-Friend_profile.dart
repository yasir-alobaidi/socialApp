...
class GviewWProfilePage extends StatefulWidget {
  const GviewWProfilePage({Key? key}) : super(key: key);

  @override
  State<GviewWProfilePage> createState() => _GviewWProfilePageState();
}

class _GviewWProfilePageState extends State<GviewWProfilePage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(SearchPage.searchedWisherName,
                              style: TextStyle(
                                  fontSize: 20, fontWeight: FontWeight.bold)),
                          Text("@" + SearchPage.searchedWisherUsername,
                              style: TextStyle(fontSize: 17)),
                          Text(SearchPage.searchedWisherBio,
                              style: TextStyle(
            ...
            Text(SearchPage.searchedWisherName + '\'s wishes',
  ...
  Widget returnAppropriateWidgets() {
    return Container();
  }
}
